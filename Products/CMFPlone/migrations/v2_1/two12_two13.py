...
def normalizeNavtreeProperties(portal):
...
def removeVcXMLRPC(portal):
    ...
    if jsreg is not None:
        if 'vcXMLRPC.js' in jsreg.getResourceIds():
            ...
            logger.info('Removed vcXMLRPC.js')


def addActionDropDownMenuIcons(portal):
    """Add icons for copy, cut, paste and delete
    """
    ...
    if added:
        logger.info('Added icons for copy, cut, paste and delete')
    else:
        logger.info('Updated icons for copy, cut, paste and delete')


def reindexCatalog(portal):
    ...
    if catalog is not None:
        ...
        logger.info("Reindexed portal_catalog.")


def indexMembersFolder(portal):
    ...
    if catalog is not None:
        ...
        if membershipTool is not None:
            ...
            if members is not None:
                members.indexObject()
                logger.info('Recataloged Members folder.')
