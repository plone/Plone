...
from Products.CMFCore.permissions import ManagePortal, AddPortalContent
...
class TempFolder(TempFolderBase):
    ...
    def __getitem__(self, id):
        ...
        if id in self.objectIds():
            ...
            if not getSecurityManager().checkPermission(AddPortalContent, self):
                raise Unauthorized(name = "invokeFactory")
            try:
